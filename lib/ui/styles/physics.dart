...
class MaiporarisuScrollPhysics extends ScrollPhysics {
  const MaiporarisuScrollPhysics({
  ...
  @override
  MaiporarisuScrollPhysics applyTo(ScrollPhysics? ancestor) {
    return MaiporarisuScrollPhysics(
